...
class MensajeController extends Controller {
  ...
  public function update() {
    try {
      ...
      $error = $e->getMessage();
      $mensaje = ['id_mensajes'=>$_POST['id_mensajes'] ?? 0, 'titulo'=>$_POST['titulo'] ?? '', 'descripcion'=>$_POST['descripcion'] ?? '', 'fecha'=>$_POST['fecha'] ?? '', 'imagen'=>$_POST['imagen_actual'] ?? null];
