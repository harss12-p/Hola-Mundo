  ...
  <div class="grid">
   <?php foreach ($mensajes as $m): ?>
    <article class="card">
     ...
     <div class="row">
      <a class="btn" href="<?= (BASE_URL ? rtrim(BASE_URL,'/') : '') ?>/mensajes/show?id_mensajes=<?= (int)$m['id_mensajes'] ?>">Ver</a>
      <a class="btn secondary" href="<?= (BASE_URL ? rtrim(BASE_URL,'/') : '') ?>/mensajes/edit?id_mensajes=<?= (int)$m['id_mensajes'] ?>">Editar</a>
     </div>
    </article>
   <?php endforeach; ?>
  </div>
